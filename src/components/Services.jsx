...
import { Stethoscope, UserPlus, Baby, Activity } from 'lucide-react';
...
const servicesList = [
  ...
  {
    title: "Child Care",
    description: "Dedicated caregivers providing a safe, nurturing, and engaging environment for your children.",
    icon: Baby,
    color: "from-pink-400 to-rose-500"
  },
  {
    title: "Physiotherapy & Surgical Instruments",
    description: "Expert physiotherapy at home and access to necessary surgical instruments for rehabilitation.",
    icon: Activity,
    ...
    <section id="services" className="py-24 bg-slate-50 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-primary font-semibold tracking-wider uppercase mb-3 text-sm">Our Services</h2>
          ...
          {servicesList.map((service, index) => {
            ...
            return (
              <motion.div 
                ...
                className="group relative rounded-2xl overflow-hidden bg-slate-100 p-[3px] shadow-sm hover:shadow-[0_20px_40px_rgba(13,148,136,0.15)] transition-shadow duration-300"
              >
                ...
                {/* Card Inner Content */}
                <div className="relative h-full bg-white rounded-xl p-8 flex flex-col items-center text-center z-10 transition-all duration-300">
                  ...
                  <h4 className="relative z-10 text-xl font-bold text-slate-800 mb-3 font-serif tracking-wide">{service.title}</h4>
                  <p className="relative z-10 text-slate-600 leading-relaxed font-medium text-sm">
                    {service.description}
                  </p>
                </div>
              </motion.div>
